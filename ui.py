...
class GraphWidget(FigureCanvas):
    ...
    def plot_balance(self, db):
        ...
        balance_data = main.get_monthly_balance(db)
    ...
    def plot_expenses(self, db):
        ...
        expense_data = main.get_monthly_spending(db, "2024-10")
    ...
    def plot_income(self, db):
        ...
        income_data = main.get_monthly_income(db)
...
class AddIncomeDialog(QDialog):
    ...
    def add_income(self):
        ...
        if date and amount:
            main.add_income(self.db, date, amount)
            self.accept()
...
class AddExpenseDialog(QDialog):
    ...
    def add_expense(self):
        ...
        if date and spend_type and amount:
            main.add_spend(self.db, date, spend_type, amount)
            self.accept()
